      ...
      >
        <div class="flex justify-between items-start mb-4">
          ...
          <div class="text-right">
            ...
            <time v-if="work.end_date" class="text-sm text-gray-500">{{
  ...
  meta: [
    {
      name: "description",
      content:
        "Professional journey, work experience, and career history of Satrio. Full-Stack Engineer at BMKG and Lead Developer at Open Knowledge Association.",
    },
    {
      name: "keywords",
      content:
        "work experience, career, professional history, software engineer, developer",
    },
    {
      property: "og:title",
      content: "Work Experience | Satrio - Professional Journey",
    },
    {
      property: "og:description",
      content:
        "Professional journey, work experience, and career history of Satrio.",
    },
